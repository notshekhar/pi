...
const GOOGLE: ModelInfo[] = [
  ...
  m("google", "gemini-2.5-flash-lite", "Gemini 2.5 Flash Lite", 1_000_000, 64_000, { input: 0.1, output: 0.4 }, false, [
    "text",
    "image",
  ]),
];
...
const GITHUB_COPILOT: ModelInfo[] = [
  ...
  m("github-copilot", "claude-opus-4-7", "Copilot · Claude Opus 4.7", 200_000, 64_000, { input: 0, output: 0 }, true, [
    "text",
    "image",
  ]),
  m(
  ...
  m("github-copilot", "gemini-2.5-pro", "Copilot · Gemini 2.5 Pro", 1_000_000, 64_000, { input: 0, output: 0 }, true, [
    "text",
    "image",
  ]),
];
