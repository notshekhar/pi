...
const EXT_TO_LANG: Record<string, string> = {
  ...
  css: "css", scss: "scss", less: "less", json: "json", yaml: "yaml", yml: "yaml", toml: "ini",
  xml: "xml", md: "markdown", markdown: "markdown", makefile: "makefile", lua: "lua", perl: "perl",
  r: "r", scala: "scala", graphql: "graphql",
};
